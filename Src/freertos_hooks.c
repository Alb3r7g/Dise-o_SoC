...
// Aquí configuramos el temporizador TIM2 para generar las interrupciones del
// tick de FreeRTOS
...
void vPortSetupTimerInterrupt(void) {
  ...
  // Aquí configuramos el prescaler, el auto-reload y los registros del TIM2
  // para operar a 1 kHz
  TIM2->PSC = 64U - 1U;
  TIM2->ARR = 1000U - 1U;
...
// Aquí manejamos la interrupción periódica de TIM2 para avanzar el tick de
// FreeRTOS
...
// Aquí proveemos la memoria estática necesaria para la tarea inactiva (Idle
// Task)
...
// Este se ejecuta si la asignación dinámica en la pila falla
...
// Este se ejecuta si alguna tarea desborda su stack asignado
